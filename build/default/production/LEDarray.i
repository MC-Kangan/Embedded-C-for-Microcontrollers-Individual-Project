...
void LEDarray_disp_PPM(unsigned int cur_val, unsigned int max)
{
 ...
 unsigned int corr;
    ...
    if (cur_val > 9+corr) { disp_val += 1;}
    if (cur_val > 19+corr) { disp_val += 2;}
    if (cur_val > 29+corr) { disp_val += 4;}
    if (cur_val > 39+corr) { disp_val += 8;}
    if (cur_val > 49+corr) { disp_val += 16;}
    if (cur_val > 59+corr) { disp_val += 32;}
    if (cur_val > 69+corr) { disp_val += 64;}
    if (cur_val > 79+corr) { disp_val += 128;}
